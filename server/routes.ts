...
import { startDeposit, createDeposit, getUserDeposits, getPendingDeposits, confirmDeposit, rejectDeposit } from "./controllers/depositController";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Deposit routes
  app.post('/api/deposits/start', startDeposit);
